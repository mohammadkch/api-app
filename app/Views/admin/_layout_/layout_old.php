...
<head>
    ...
    <!-- ratio css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/back/css/ratio.css">
    ...
    <!-- vector map css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/back/css/vector-map.css">
    ...
    <!-- Bootstrap-tag input css (جدید) -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/back/css/vendors/bootstrap-tagsinput.css">

    <!--Dropzon css (جدید) -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/back/css/vendors/dropzone.css">

    <!-- Select2 css (جدید) -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/back/css/select2.min.css">

    <!-- Plugins css (جدید) -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/back/css/vendors/chartist.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/back/css/vendors/date-picker.css">
...
<!-- bootstrap tag-input js (جدید) -->
<script src="<?= base_url() ?>assets/back/js/bootstrap-tagsinput.min.js"></script>

<!-- ck editor js (جدید) -->
<script src="<?= base_url() ?>assets/back/js/ckeditor.js"></script>
<script src="<?= base_url() ?>assets/back/js/ckeditor-custom.js"></script>

<!-- Dropzon js (جدید) -->
<script src="<?= base_url() ?>assets/back/js/dropzone/dropzone.js"></script>
<script src="<?= base_url() ?>assets/back/js/dropzone/dropzone-script.js"></script>
